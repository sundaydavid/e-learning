				...
				<div class="row-fluid">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">School Year:
								<?php echo $school_year_query_row['school_year']; ?>
							</a></li>
					</ul>
					<!-- end breadcrumb -->
							...
							<div class="span12">
								...
								<form action="read.php" method="post">
									<?php if ($not_read == '0') {
										...
										<button id="delete" class="btn btn-info" name="read"><i class="icon-check"></i>
											Read</button>
					...
					") or die(mysqli_error());
									...
									if ($count > 0) {
										...
										?>
										<div class="alert alert-info"><strong><i class="icon-info-sign"></i> No
